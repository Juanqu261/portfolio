...
- **Backend:** FastAPI · policy gates · sessions, cache, metrics
- **Agents:** LangGraph specialists for text, image, and chart analysis (Gemini)
- **Tooling:** `uv` Python workspace · Ruff · pytest · Docker · Cloud Run
...
- Cloud Run deployment is configured separately; the repo only documents env vars
